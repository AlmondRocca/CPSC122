...
{ 
  public: 
  /*
   I lost all my code and dont have the energy for this bullshit
  */
  int Evaluate();
 ...
 */
  ...
  */
  ...
  /*
   pre: invoked from CheckTokens
   post: Returns true or false if its a math operator like +-/*
  */
  bool IsOperator(char ch);

  /*
   pre: invoked from Parse
   post: Copies a string into inFix
  */
  void copyStrToInFix(std::string s);
  ...
  */
  ...
  /*
   I lost all my code and dont have the energy for this bullshit
  */
  double DoTheMath(int op1, int op2, char op);

  /*
    Still lost my code fuck you github
  */
  void CopyStrToPostFix(string s);
